      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 md:gap-20">
        ...
        >
          <div className="space-y-5">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-[color:var(--pm-text-muted)] md:text-base md:font-medium md:text-[color:var(--pm-text-main)]/80">
        ...
        <section aria-labelledby="why-heading">
          ...
          <p className="mt-1.5 max-w-2xl text-sm font-medium text-[color:var(--pm-text-muted)]">
            Built for repeatable, actionable practice — not generic AI fluff.
          </p>
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="border-[color:var(--pm-border-subtle)] bg-[color:var(--pm-surface)] px-5 py-4 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
        ...
        {/* Final CTA */}
        <section
          className="rounded-2xl border border-[color:var(--pm-border-subtle)]/70 bg-[color:var(--pm-surface-soft)]/90 px-6 py-6 text-center md:px-8 md:py-7"
        ...
        >
          ...
          <p className="mx-auto mt-1.5 max-w-sm text-xs text-[color:var(--pm-text-muted)]">
